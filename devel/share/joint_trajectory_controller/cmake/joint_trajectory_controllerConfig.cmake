...
if("TRUE" STREQUAL "TRUE")
  set(joint_trajectory_controller_SOURCE_PREFIX /home/stagiaire019/astek_ws/src/ros_controllers/joint_trajectory_controller)
  set(joint_trajectory_controller_DEVEL_PREFIX /home/stagiaire019/astek_ws/devel)
  ...
  set(joint_trajectory_controller_INSTALL_PREFIX /home/stagiaire019/astek_ws/install)
...
if(NOT "/home/stagiaire019/astek_ws/src/ros_controllers/joint_trajectory_controller/include " STREQUAL " ")
  set(joint_trajectory_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/stagiaire019/astek_ws/src/ros_controllers/joint_trajectory_controller/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'joint_trajectory_controller' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'joint_trajectory_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/stagiaire019/astek_ws/src/ros_controllers/joint_trajectory_controller/${idir}'.  ${_report}")
    endif()
