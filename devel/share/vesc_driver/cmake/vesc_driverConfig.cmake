...
if("TRUE" STREQUAL "TRUE")
  set(vesc_driver_SOURCE_PREFIX /home/stagiaire019/astek_ws/src/vesc/vesc_driver)
  set(vesc_driver_DEVEL_PREFIX /home/stagiaire019/astek_ws/devel)
  ...
  set(vesc_driver_INSTALL_PREFIX /home/stagiaire019/astek_ws/install)
...
if(NOT "/home/stagiaire019/astek_ws/src/vesc/vesc_driver/include " STREQUAL " ")
  set(vesc_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/stagiaire019/astek_ws/src/vesc/vesc_driver/include")
  ...
  elseif(NOT "http://www.ros.org/wiki/vesc_driver " STREQUAL " ")
    set(_report "Check the website 'http://www.ros.org/wiki/vesc_driver' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'vesc_driver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'vesc_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/stagiaire019/astek_ws/src/vesc/vesc_driver/${idir}'.  ${_report}")
    endif()
